...
class Toolbox extends Component<Props, State> {
        ...
        socket.on(meetingid, async (payload) => {
            ...
            switch (payload.eventName) {
                ...
                case "handleApprove":
                    ...
                    axios.post(interfaceConfig.DOMAIN + "/savehistory", {
                        meeting_id: meetingid,
                        name: name,
                        key: "",
                ...
                case "kickOut": // Case KickUser
                    logger.log("kickOut", infoUser.getUserId());
                    if (payload.userId != infoUser.getUserId()) _endjoin();
                    break;
    ...
    componentDidUpdate(prevProps) {
        ...
        if (
            ...
            // this._onSetOverflowVisible(false);
            this._onSetOverflowVisible(true);
